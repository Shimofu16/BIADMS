    ...
    <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
            ...
            <a href="#" class="flex items-center justify-between mr-4">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BIADMS</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button" class="flex mx-3 text-sm rounded-full focus:ring-4 focus:ring-gray-300"
                ...
                <?php if (!empty($user['image'])): ?>
                    <img class="w-8 h-8 rounded-full object-cover"
                        src="/uploads/users/<?= htmlspecialchars($user['image']) ?>"
